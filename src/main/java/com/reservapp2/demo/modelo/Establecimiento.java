...
public class Establecimiento  implements java.io.Serializable {
    ...
    public Establecimiento(Integer idEstablecimiento, String nit, Integer mesas) {
        this.idEstablecimiento = idEstablecimiento;
        this.nit = nit;
        this.mesas = mesas;
    }
    public Establecimiento(Integer idEstablecimiento, String nombre, String nit, String direccion, String correo, String telefono, String longitud, String latitud, Integer mesas, Set<Menu> menus, Set<Mesa> mesas_1) {
       this.idEstablecimiento = idEstablecimiento;
       this.nombre = nombre;
       this.nit = nit;
