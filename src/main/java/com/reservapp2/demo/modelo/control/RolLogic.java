    ...
    */
    ...
    public void saveRol(Rol entity) throws Exception {
        ...
        try {
            ...
            if (getRol(entity.getIdRol()) != null) {
    ...
    public void deleteRol(Rol entity) throws Exception {
        ...
        try {
            usuarios = usuarioDAO.findByProperty("rol.idRol", entity.getIdRol());
    ...
    public List<RolDTO> getDataRol() throws Exception {
        try {
            ...
            for (Rol rolTmp : rol) {
                ...
                rolDTO2.setIdRol(rolTmp.getIdRol());
