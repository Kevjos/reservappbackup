package com.reservapp2.demo.modelo.control;

import com.reservapp2.demo.dataaccess.dao.*;
import com.reservapp2.demo.exceptions.*;
import com.reservapp2.demo.modelo.*;
import com.reservapp2.demo.modelo.dto.ReservaDTO;
import com.reservapp2.demo.utilities.Utilities;
    ...
    */
    ...
    public void saveReserva(Reserva entity) throws Exception {
        ...
        try {
            ...
            if (entity.getMesa().getIdMesa() == null) {
                throw new ZMessManager().new EmptyFieldException("idMesa_Mesa");
            }

            if (entity.getUsuario().getIdUsuario() == null) {
                throw new ZMessManager().new EmptyFieldException(
                    "idUsuario_Usuario");
            }

            if (getReserva(entity.getIdReserva()) != null) {
    ...
    public void deleteReserva(Reserva entity) throws Exception {
        ...
        if (entity.getIdReserva() == null) {
            throw new ZMessManager().new EmptyFieldException("idReserva");
        }

        List<Factura> facturas = null;

        try {
            facturas = facturaDAO.findByProperty("reserva.idReserva",
                    entity.getIdReserva());
    ...
    public List<ReservaDTO> getDataReserva() throws Exception {
        try {
            ...
            for (Reserva reservaTmp : reserva) {
                ...
                reservaDTO2.setIdReserva(reservaTmp.getIdReserva());
                ...
                reservaDTO2.setIdMesa_Mesa((reservaTmp.getMesa().getIdMesa() != null)
                    ? reservaTmp.getMesa().getIdMesa() : null);
                reservaDTO2.setIdUsuario_Usuario((reservaTmp.getUsuario()
                                                            .getIdUsuario() != null)
                    ? reservaTmp.getUsuario().getIdUsuario() : null);
    ...
    public Reserva getReserva(Integer idReserva) throws Exception {
        ...
        try {
            entity = reservaDAO.findById(idReserva);
        } catch (Exception e) {
