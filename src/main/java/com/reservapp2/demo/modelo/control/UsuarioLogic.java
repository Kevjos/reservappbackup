    ...
    */
    ...
    public void saveUsuario(Usuario entity) throws Exception {
        ...
        try {
            ...
            if ((entity.getRol_1() != null) &&
                    (Utilities.checkWordAndCheckWithlength(entity.getRol_1(), 45) == false)) {
                throw new ZMessManager().new NotValidFormatException("rol_1");
            }
            ...
            if (entity.getRol().getIdRol() == null) {
                throw new ZMessManager().new EmptyFieldException("idRol_Rol");
            }
    ...
    public void deleteUsuario(Usuario entity) throws Exception {
        ...
        try {
            reservas = reservaDAO.findByProperty("usuario.idUsuario",
                    entity.getIdUsuario());
    ...
    public List<UsuarioDTO> getDataUsuario() throws Exception {
        try {
            ...
            for (Usuario usuarioTmp : usuario) {
                ...
                usuarioDTO2.setIdUsuario(usuarioTmp.getIdUsuario());
                ...
                usuarioDTO2.setRol_1((usuarioTmp.getRol_1() != null)
                    ? usuarioTmp.getRol_1() : null);
                ...
                usuarioDTO2.setIdRol_Rol((usuarioTmp.getRol().getIdRol() != null)
                    ? usuarioTmp.getRol().getIdRol() : null);
