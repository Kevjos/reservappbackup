package com.reservapp2.demo.presentation.businessDelegate;

import com.reservapp2.demo.modelo.Establecimiento;
import com.reservapp2.demo.modelo.Factura;
import com.reservapp2.demo.modelo.Menu;
import com.reservapp2.demo.modelo.Mesa;
import com.reservapp2.demo.modelo.Reserva;
import com.reservapp2.demo.modelo.Rol;
import com.reservapp2.demo.modelo.Usuario;
import com.reservapp2.demo.modelo.control.EstablecimientoLogic;
import com.reservapp2.demo.modelo.control.FacturaLogic;
import com.reservapp2.demo.modelo.control.IEstablecimientoLogic;
import com.reservapp2.demo.modelo.control.IFacturaLogic;
import com.reservapp2.demo.modelo.control.IMenuLogic;
import com.reservapp2.demo.modelo.control.IMesaLogic;
import com.reservapp2.demo.modelo.control.IReservaLogic;
import com.reservapp2.demo.modelo.control.IRolLogic;
import com.reservapp2.demo.modelo.control.IUsuarioLogic;
import com.reservapp2.demo.modelo.control.MenuLogic;
import com.reservapp2.demo.modelo.control.MesaLogic;
import com.reservapp2.demo.modelo.control.ReservaLogic;
import com.reservapp2.demo.modelo.control.RolLogic;
import com.reservapp2.demo.modelo.control.UsuarioLogic;
import com.reservapp2.demo.modelo.dto.EstablecimientoDTO;
import com.reservapp2.demo.modelo.dto.FacturaDTO;
import com.reservapp2.demo.modelo.dto.MenuDTO;
import com.reservapp2.demo.modelo.dto.MesaDTO;
import com.reservapp2.demo.modelo.dto.ReservaDTO;
import com.reservapp2.demo.modelo.dto.RolDTO;
import com.reservapp2.demo.modelo.dto.UsuarioDTO;
import com.reservapp2.demo.presentation.businessDelegate.IBusinessDelegatorView;
...
public class BusinessDelegatorView implements IBusinessDelegatorView {
    ...
    public Factura getFactura(Integer idFactura) throws Exception {
        ...
        try {
            factura = facturaLogic.getFactura(idFactura);
        } catch (Exception e) {
            throw e;
        }
    ...
    public Reserva getReserva(Integer idReserva) throws Exception {
        ...
        try {
            reserva = reservaLogic.getReserva(idReserva);
        } catch (Exception e) {
            throw e;
        }
